...
public class CategoryGraph extends Graph{
  ...
  public CategoryGraph(ArrayList<Team> t, Method method) {// reflection only works with a method that returns an float
    teams = t;
    this.method = method;
    setPrintingValues();
  ...
  public void update() {
    if(mousePressed && mouseX > width-320 && mouseY < 45){
      gameState = "main menu";
    }
  }
